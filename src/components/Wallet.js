    ...
    <section className="bg-gray-100 text-gray-900 min-h-screen">
      <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
        ...
        <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
          <h1 className="text-5xl font-bold leading-none sm:text-6xl">Balance: 3,2244</h1>
          <p className="mt-6 mb-8 text-lg sm:mb-12">
            Originally referred to as Ethereum 2.0, the merge is an upgraded version of the Ethereum
            blockchain that uses a proof-of-stake consensus mechanism to verify transactions via
            staking.
          </p>
